...
pub enum RobStride06Parameter {
    ...
    IqRef,       // 0x7006 - Current mode Iq command (-57A to 57A)
    SpdRef,      // 0x700A - Speed mode command (-50 to 50 rad/s)
    LimitTorque, // 0x700B - Torque limitation (0-36 Nm)
    CurKp,       // 0x7010 - Current Kp (default 0.17)
    CurKi,       // 0x7011 - Current Ki (default 0.012)
    CurFitGain,  // 0x7014 - Current filter coefficient (0-1.0, default 0.1)
    Ref,         // 0x7016 - Position mode angle command (rad)
    LimitSpd,    // 0x7017 - Position mode speed limit (0-50 rad/s)
    LimitCur,    // 0x7018 - Speed/position mode current limit (0-57A)
    MechPos,     // 0x7019 - Load end mechanical angle (rad)
    Iqf,         // 0x701A - Iq filter values (-57A to 57A)
    MechVel,     // 0x701B - Load end speed (-15 to 15 rad/s)
    VBus,        // 0x701C - Bus voltage (V)
    LocKp,       // 0x701E - Position Kp (default 40)
    SpdKp,       // 0x701F - Speed Kp (default 6)
    SpdKi,       // 0x7020 - Speed Ki (default 0.02)
